...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 9, vars: 0, consts: [[1, "container", 3, "resize"], [1, "row", "navbar"], ["routerLink", ""], ["src", "../assets/bb_logo.svg", 1, "navbar-logo"], ["id", "content", 1, "row"], ["id", "footer", 1, "row"], ["id", "attribution"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        ...
        _error_card_error_card_component__WEBPACK_IMPORTED_MODULE_14__["ErrorCardComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"],
        _angular_material_input__WEBPACK_IMPORTED_MODULE_7__["MatInputModule"],
        _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_8__["MatToolbarModule"],
...
/* harmony import */ var _system_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./system.model */ "./src/app/system.model.ts");
...
class BikeshareDataService {
    ...
    getFeedFromDiscovery(feedName) {
        return this.http.get(this.selectedSystem.discoveryUrl, { responseType: 'json' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(x => x['data']['en']['feeds']), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(feeds => feeds.filter((feed) => feed.name === feedName)[0].url));
    }
    ...
    getSystemFeed(feedName) {
        return this.getFeedFromDiscovery(feedName)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["mergeMap"])(feed => this.http.get(feed, { responseType: 'json' })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(x => { this.systemError = false; return x['data']['stations']; }))
    ...
    setSystemByID(sysID) {
        return this.getSystemsArray().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(sysArray => {
    ...
    getSystemsArray() {
        // let allSystems = [];
        return this.getAllSystemsCsv().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(data => data.split('\n').slice(1, -1)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(lines => lines.map(line => {
        ...
        }))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(sysArr => this.allSystems = sysArr));
    }
}
BikeshareDataService.ɵfac = function BikeshareDataService_Factory(t) { return new (t || BikeshareDataService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"])); };
...
/* harmony import */ var _error_card_error_card_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../error-card/error-card.component */ "./src/app/error-card/error-card.component.ts");
...
class MapComponent {
    constructor(bikeshareDataService, route, router) {
        this.bikeshareDataService = bikeshareDataService;
        this.route = route;
        this.router = router;
...
MapComponent.ɵfac = function MapComponent_Factory(t) { return new (t || MapComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_bikeshare_data_service__WEBPACK_IMPORTED_MODULE_2__["BikeshareDataService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"])); };
MapComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MapComponent, selectors: [["app-map"]], viewQuery: function MapComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, outputs: { switchToSearch: "switchToSearch" }, decls: 5, vars: 2, consts: [["class", "loading-spinner", 4, "ngIf"], [4, "ngIf"], ["id", "map-container"], ["map", ""], [1, "loading-spinner"]], template: function MapComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MapComponent, [{
    ...
    }], function () { return [{ type: _bikeshare_data_service__WEBPACK_IMPORTED_MODULE_2__["BikeshareDataService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }]; }, { switchToSearch: [{
